...
export default function Demo() {
  ...
  return (
    <section id="demo" ref={sectionRef} className="bg-cream">
      <div className="mx-auto max-w-5xl px-4 py-24">
        ...
        <h2 className="mb-6 text-center text-3xl font-medium text-ink md:text-4xl">
        ...
        <div
          className="mx-auto max-w-4xl overflow-hidden rounded-2xl border border-border bg-white shadow-2xl"
          style={{
            opacity: visible ? 1 : 0,
